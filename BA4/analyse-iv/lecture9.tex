...
\begin{proof}
	...
	\begin{align*} 
		&=  \int_0^{\infty}f\left(s\right) e^{\left(-z + b\right)\frac{s}{a}}\frac{ds}{a}\\
		&= \frac{1}{a}\int_0^{\infty}f\left(s\right)e^{-\frac{z + b}{a}s}ds = \frac{1}{a}\mathcal{L}\left[f\right]\left(\frac{z + b}{a}\right)
	\end{align*}
\end{proof}
...
\begin{parag}{Example}
	...
	\begin{align*} 
		\mathcal{L}\left[f\right]\left(z\right) &= \frac{1}{b-a} \left[\frac{1}{z-b} - \frac{1}{z-a}\right]\\
												...
												&= \mathcal{L}\left[\frac{e^{bt} - e^{at}}{b-a}\right]\left(z\right)
	\end{align*}
