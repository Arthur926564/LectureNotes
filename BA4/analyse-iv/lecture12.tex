...
\begin{align*} 
	\begin{cases}
		\frac{\partial u}{\partial t}  - \frac{\partial^2 u}{\partial x^2} = f \mathspace \mathspace \forall t > 0, x \in \left(0, L\right)\\
...
\begin{align*} 
	\text{PDE} \overbrace{\longrightarrow}^{\text{Fourier}}  \text{ODE} \overbrace{\longrightarrow}^{\text{Laplace}}  \text{solution}
\end{align*}
...
\begin{proof}
	...
	\begin{align*} 
		\frac{d}{dt} \int_{0}^{L}v^2\left(x, t\right)dx &= 2 \int_{0}^{L}v\left(x, t\right)\frac{\partial v}{\partial t} \left(x, t\right) dx \\
		&= 2 \int_{0}^{L}v\left(x, t\right) \frac{\partial^2 v}{\partial x^2} \left(x, t\right)dx
	\end{align*}
	Using integration by part 
	\begin{align*} 
		&=  2\left[v\left(x, t\right)\frac{\partial v}{\partial x} \left(x, t\right)\right]_{0}^{L} - 2\int_{0}^{L}\frac{\partial v}{\partial x} \left(x, t\right)^2 dx\\
	...
	\begin{align*} 
		0 \leq \int_{0}^{L} v^2\left(x, t\right)dx \leq \int_{0}^{L}v^2 \left(x, 0\right) dx = 0
	\end{align*}
...
\begin{definition}{Wave equation}
	\begin{align*} 
		\begin{cases}
			...
			u|_{t= 0} = u_0\\
			\frac{\partial u}{\partial t} \mid_{t= 0}= u_1\\
			u|_{x= 0}= u|_{x= L} = 0
		\end{cases} 
	\end{align*}
...
\begin{parag}{Existence}
    \begin{proof}
		...
		\begin{align*} 
			...
			\frac{\partial^2 u}{\partial x^2} \left(x, t\right) =  \sum_{n = 1}^{\infty}b_n\left(t\right)\left(-\frac{\pi^2n^2}{L^2}\right) \sin\left(\frac{\pi n}{L}x\right)
		\end{align*}
