\begin{parag}{$ $}
	...
	\begin{align*} \int_{-\infty}^{\infty}R\left(x\right)e^{iax}dx \end{align*}
...
\paragraph{Integrals of rational functions of trigonometric functions}%
	...
	We have:
	\begin{align*} 
		\int_0^{2\pi}\frac{P\left(\cos t, \sin t\right)}{Q\left(\cos t, \sin t\right)}dt &= \int_0^{2\pi}\frac{P\left(\frac{e^{it} + e^{-it}}{2}, \frac{e^{it} - e^{-it}}{2i}\right)}{Q\left(\frac{e^{it} + e^{-it}}{2}, \frac{e^{it} - e^{-it}}{2i}\right)}dt\\
		&= \int_0^{2\pi} \frac{P\left(\cdots\right)}{Q\left(\cdots\right)}\frac{1}{ie^{it}}ie^{it}dt
	\end{align*}
	Now we can set 
	\begin{align*} 
	...
	$ $\\
	Since $P, Q$ are polynomials, $f$ is holomorphic on $\mathbb{C} \setminus \left\{z_1, \ldots, z_k\right\}$ where $z_1, \ldots, z_k$ are the point where the denominator vanishes
	\begin{parag}{$ $}
	...
	\end{subparag}
	\end{parag}
	If $z_1, \ldots, z_l$ are the points of $z_1, \ldots, z_k$ lying in the \important{interior of the unit circle}, the residue theorem implies:
	\begin{align*} 
	\boxed{
