...
\begin{parag}{Overflow in software}
	...
	\begin{itemize}
	    \item If addition of \important{opposite sign number}, magnitude can only reduce $\to$\important{no overflow possible}
	    \item If addition of \important{same sign number}, overflow is possible but the sign of the result will appear wrong.
	\end{itemize}
