...
\begin{parag}{Any Advantage Now?}
	...
	\begin{itemize}
		...
		\item In the circuit with the registers used for a single calculation, \important{every $N$ cycles of period $\frac{T}{N}$} \textrightarrow every $T$
...
\begin{parag}{Latency and Throughput}
		...
		\end{definition}
	    \begin{itemize}
			\item Original circuit: $\frac{1}{T} = f$
...
\begin{parag}{Useful Representaiton of the Pipeline Activity}
